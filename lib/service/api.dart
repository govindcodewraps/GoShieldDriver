...
class API {
  //https://cab.goshieldapp.com/admin/
  //static const baseUrl = "${"https://cab.codewraps.com/admin"}/api/v1/"; // live
  static const baseUrl = "${"https://cab.goshieldapp.com"}/api/v1/"; // live
  static const apiKey = "base64:bo5OOx/QcgmosOh2KajKY8M7x1ivq8+4hT2bHovp3/A=";
