...
class SignupScreen extends StatefulWidget {
  ...
  SignupScreen({super.key,this.phoneNumber,this.emailId});
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void initState() {
    super.initState();
    // Check if phoneNumber is null, if not, set the text in _phoneController
    if (widget.phoneNumber != null) {
      _phoneController.text = widget.phoneNumber.toString();
    }

    // Set the text in _emailController based on widget.emailId
