    ...
    return GetX<DashBoardController>(
      ...
      builder: (controller) {
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            appBar: AppBar(
              backgroundColor: controller.selectedDrawerIndex.value ==
                      (Constant.parcelActive == "yes" &&
                              controller.userModel!.userData!.parcelDelivery
                                      .toString() ==
                                  "yes"
                          ? 4
                          : 2)
                  ...
                  currentAccountPicture: ClipOval(
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: controller.userModel!.userData!.photoPath
                            .toString(),
                        fit: BoxFit.fill,
                        ...
                        child: Switch(
                            ...
                            onChanged: (value) {
                              ...
                              Map<String, dynamic> bodyParams = {
                                ...
                                'online':
                                    controller.isActive.value ? 'yes' : 'no',
                              };
