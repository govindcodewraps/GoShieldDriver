...
import 'package:goshield_driver/model/parcel_details_model.dart';
import 'package:goshield_driver/model/ride_details_model.dart';
...
class PaymentController extends GetxController {
  ...
  getArgument() async {
    ...
    if (argumentData != null) {
      ...
      discountAmount.value = data.value.discount != "null"
